// The `/` route: useActiveSaleRedirect does the fetch + navigate; this
// component only renders the placeholder for each of that hook's states.
// No flash of content while loading — the noon-yellow field
// (styles/base.css) is already the page background, so an empty/near-empty
// body reads as "still loading", not broken.
